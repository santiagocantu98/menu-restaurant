...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { comment: @suggestion.comment, email: @suggestion.email, menu_id: @suggestion.menu_id } }, as: :json
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { comment: @suggestion.comment, email: @suggestion.email, menu_id: @suggestion.menu_id } }, as: :json
    assert_response 200
  end
